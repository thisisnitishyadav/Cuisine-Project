                ...
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        ...
                        <CardFooter className="d-flex align-items-center">
                            ...
                            <CardTitle className="text-success">Arpit</CardTitle>
                        </CardFooter>
                    </Card>
                </div>
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        ...
                        <CardFooter className="d-flex align-items-center">
                            ...
                            <CardTitle className="text-success">Aastha Srivastav </CardTitle>
                        </CardFooter>
                    </Card>
                </div>
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        ...
                        <CardFooter className="d-flex align-items-center">
                            ...
                            <CardTitle className="text-success">Prasansha Jangir</CardTitle>
                        </CardFooter>
                    </Card>
                </div>
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        ...
                        <CardFooter className="d-flex align-items-center">
                            ...
                            <CardTitle className="text-success">Hardik Damor</CardTitle>
                        </CardFooter>
                    </Card>
                </div>
            </div>
